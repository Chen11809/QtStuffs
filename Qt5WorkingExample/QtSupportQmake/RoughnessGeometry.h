...
class RoughnessGeometry : public Qt3DRender::QGeometry
{
    Q_OBJECT
    Q_PROPERTY(PhenomWorld::FullHDUI::Roughness::HitDetection::PointGrid pointGrid READ getPointGrid WRITE setPointGrid NOTIFY pointGridChanged)
...
private:
    ...
    QScopedPointer<Qt3DRender::QAttribute> m_positionAttribute;
    QScopedPointer<Qt3DRender::QAttribute> m_textureAttribute;
    QScopedPointer<Qt3DRender::QAttribute> m_indexAttribute;

    QScopedPointer<Qt3DRender::QBuffer> m_vertexBuffer;
    QScopedPointer<Qt3DRender::QBuffer> m_indexBuffer;
