...
RoughnessGeometry::RoughnessGeometry(Qt3DCore::QNode* parent)
    : QGeometry(parent)
{
    m_vertexBuffer.reset(new Qt3DCore::QBuffer(this));
    m_indexBuffer.reset(new Qt3DCore::QBuffer(this));
    m_positionAttribute.reset(new Qt3DCore::QAttribute());
    m_textureAttribute.reset(new Qt3DCore::QAttribute());
    m_indexAttribute.reset(new Qt3DCore::QAttribute());
